...
<div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">
    Verify your email address for TBM Events.
</div>
            ...
            <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="width:600px;max-width:600px;">
                ...
                <tr>
                    <td style="background-color:#FFFFFF;border:1px solid rgba(15,23,42,0.08);border-radius:4px;overflow:hidden;box-shadow:0 10px 30px rgba(15,23,42,0.06);">
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                            <tr>
                                <td style="padding:18px 22px 8px 22px;">
                                    <div style="font-family:Inter,Segoe UI,Arial,sans-serif;font-size:14px;line-height:22px;color:#111827;">
                                        Hi {{ $user->full_name ?: $user->business_name }},
                                        <br /><br />
                                        Please verify your email address by clicking the button below. This link expires in <strong>30 minutes</strong>.
                                    </div>
                                </td>
                            </tr>
                            ...
                            <!-- CTA -->
                            <tr>
                                <td align="center" style="padding:10px 22px 14px 22px;">
                                    <a
                                        href="{{ $verifyUrl }}"
                                        style="display:inline-block;background-color:#0F172A;color:#FFFFFF;text-decoration:none;font-family:Inter,Segoe UI,Arial,sans-serif;font-size:14px;line-height:18px;font-weight:800;padding:12px 18px;border-radius:12px;"
                                    >Verify email</a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="padding:0 22px 18px 22px;">
                                    <div style="font-family:Inter,Segoe UI,Arial,sans-serif;font-size:12px;line-height:18px;color:#6B7280;">
                                        ...
                                        <br />
                                        <a href="{{ $verifyUrl }}" style="color:#4F8A92;text-decoration:none;font-weight:700;word-break:break-all;">{{ $verifyUrl }}</a>
                                        <br /><br />
                ...
                <tr>
                    <td style="padding:14px 10px 0 10px;">
                        <div style="font-family:Inter,Segoe UI,Arial,sans-serif;font-size:11px;line-height:16px;color:#9CA3AF;text-align:center;">
